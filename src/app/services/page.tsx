...
// metadata must be in a server component — moved to a wrapper below
      ...
      <section className="py-16 lg:py-20" style={{ backgroundColor: "var(--color-surface-base)" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {premiumServices.map(({ id, Icon, title, blurb, detail }) => (
              <div
                key={id}
                id={id}
                className="p-7 rounded-2xl scroll-mt-20"
      ...
      <section className="py-16" style={{ backgroundColor: "var(--color-surface-warm)" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {supportingServices.map(({ id, Icon, title, desc, hasList }) => (
              <div
                key={id}
                id={id}
                className="p-6 rounded-xl scroll-mt-20"
